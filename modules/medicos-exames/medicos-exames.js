    ...
    card.innerHTML = `
      ...
      <div class="doctor-main">
        ...
        <div class="doctor-badges">
          ...
          <span class="badge dark">${escapeHTML(medico.idade || "Idade a confirmar")}</span>
...
function renderizarDetalheMedico() {
  ...
  detail.innerHTML = `
    ...
    <div class="detail-body">
      ...
      <div class="detail-line"><small>Idade atendida</small><strong>${escapeHTML(medico.idade || "A confirmar")}</strong></div>
  ...
  filtrados.forEach(exame => {
    ...
    tr.innerHTML = `
      <td data-label="Exame" class="exam-name">
        ...
        <span class="exam-note">${escapeHTML(exame.observacao || "Sem observação interna")}</span>
      </td>
...
function fecharModalMedico() {
  ...
  if (!$("modalExameOverlay")?.classList.contains("active")) document.body.classList.remove("modal-open");
}
...
function fecharModalExame() {
  ...
  modal?.classList.remove("active");
  modal?.setAttribute("aria-hidden", "true");
  if (!$("modalMedicoOverlay")?.classList.contains("active")) document.body.classList.remove("modal-open");
}
