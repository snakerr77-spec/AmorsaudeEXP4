// Esta cópia do projeto foi preparada para edição livre: não exige login e
// todas as áreas são abertas com permissões de administrador.
const MODO_EDICAO_LIVRE = true;
