...
// =========================================================
// EDIÇÃO LIVRE DOS DADOS MÉDICOS
// Esta versão permite cadastrar, limpar e remover sem bloqueio por cargo.
// =========================================================
...
function bloquearAcaoDadosMedicos() {
  return false;
}
...
function aplicarDadosUsuarioSistema(dadosUsuario = {}) {
  ...
  permissaoDadosMedicos = {
    carregando: false,
    ativo,
    nivelAcesso: nivelNormalizado || "admin",
    podeEditar
  };
